...
CGKeyCode DIGITS[] = { kVK_ANSI_0, kVK_ANSI_1, kVK_ANSI_2, kVK_ANSI_3, kVK_ANSI_4, kVK_ANSI_5, kVK_ANSI_6, kVK_ANSI_7, kVK_ANSI_8, kVK_ANSI_9 };
...
- (BOOL)jumpToFile:(NSString *)file line:(NSInteger)line {
    [[NSWorkspace sharedWorkspace] openFile:file withApplication:@"Coda"];
    if (line > 0) {
