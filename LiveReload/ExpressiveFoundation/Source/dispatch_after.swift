...
public func dispatch_after_ms(delayMs: Int64, block: dispatch_block_t) {
    dispatch_after_ms(delayMs, queue: dispatch_get_main_queue(), block: block)
}
...
public func dispatch_after_s(delay: NSTimeInterval, block: dispatch_block_t) {
    dispatch_after_s(delay, queue: dispatch_get_main_queue(), block: block)
}
