...
#import "LROutputMappingOptionController.h"
#import "ATMacViewCreation.h"


@interface LROutputMappingOptionController ()

@end


@implementation LROutputMappingOptionController

//- (void)loadView {
//    self.view = _popUpButton = [[[[NSPopUpButton popUpButton] withBezelStyle:NSRoundRectBezelStyle] withTarget:self action:@selector(filterOptionSelected:)] addedToView:self];
//}
//
