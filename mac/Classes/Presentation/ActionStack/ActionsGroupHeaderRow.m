...
- (void)loadContent {
    ...
    self.filterLabel = [[NSTextField staticLabelWithString:@"When"] addedToView:self];
    self.filterLabel.font = [NSFont systemFontOfSize:11];
    self.filterLabel.textColor = [NSColor headerColor];
