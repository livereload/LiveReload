...
- (void)loadContent {
    ...
    self.fromLabel = [[NSTextField staticLabelWithString:@"From" style:self.metrics[@"columnHeaderStyle"]] addedToView:self];
    self.toLabel = [[NSTextField staticLabelWithString:@"To" style:self.metrics[@"columnHeaderStyle"]] addedToView:self];
