...
(function() {
  ...
  URLOverrideCoordinator = (function() {
    ...
    URLOverrideCoordinator.prototype.handleHttpRequest = function(url, callback) {
      ...
      if (errCode === 404) return callback(ERR_NOT_MATCHED);
      if (errCode === 403) return callback(ERR_AUTH_FAILED);
      if (errCode !== 200) return callback(errCode);
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "cli/lib/network/urloverride.iced",
        ...
        var _ref1;
        if (!exists) return callback(ERR_FILE_NOT_FOUND);
