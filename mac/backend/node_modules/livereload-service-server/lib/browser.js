(function() {
  var BrowserService, LRWebSocketServer, Path, fs, soa, urloverride,
  ...
  BrowserService = (function(_super) {
    __extends(BrowserService, _super);

    function BrowserService(carrier, options) {
      BrowserService.__super__.constructor.call(this, carrier, options);
      this.refreshCount = 0;
      this.urlOverrideCoordinator = new urloverride.URLOverrideCoordinator();
    }

    BrowserService.prototype.on_init = function(command, callback) {
      var _this = this;
    ...
    BrowserService.prototype.on_reload = function(command, callback) {
      var _this = this;
    ...
    BrowserService.prototype.dispose = function(callback) {
      if (!this.server) {
        return callback(null);
      }
    ...
    BrowserService.prototype._disposeDone = function(callback) {
      this._log('verbose', "WebSocket server closed.");
      return callback(null);
    };

    BrowserService.prototype._reload = function(message) {
      var _this = this;
    ...
    BrowserService.prototype._handleIncomingCommand = function(connection, message) {
      return this._log('verbose', "Ignoring incoming browser notification: " + JSON.stringify(message));
    };

    BrowserService.prototype._connectionCountChanged = function() {
      return this.send({
        service: 'kernel',
    ...
    BrowserService.prototype._refreshCountChanged = function() {
      return this.send({
        service: 'kernel',
    ...
    BrowserService.prototype._serveLiveReloadJs = function(req, res) {
      var _this = this;
    ...
    BrowserService.prototype._onhttprequest = function(url, request, response) {
      var _this = this;
    ...
    BrowserService.prototype._handleServerError = function() {
      return this.send({
        service: 'kernel',
    ...
    BrowserService.prototype._log = function(level, text) {
      return this.send({
        service: 'kernel',
        command: 'log',
        level: level,
