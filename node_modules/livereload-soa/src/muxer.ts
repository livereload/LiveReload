...
class MuxerService implements api.MasterCarrier {
    private serviceCarriers = [];

    constructor(public carrier) {
        this.carrier = carrier;
    }

    onmessage(message) {
        var service = this._findService(message);
        if (service)
...
class MuxerCarrier implements api.Carrier {
    public providedServices = [];

    constructor(public muxer, public service) {
    }
