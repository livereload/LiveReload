...
class MainWindow
  ...
  initialize: ->
    ...
    @parentModel = @app  # TODO FIXME


  ##################################################################################################
  # status

  automatically_render_status: ->
    stats = @app.stats
  ...
  automatically_render_project_list: ->
    @SEND
      '#treeViewProjects':
        data:
  ...
  automatically_enable_project_list_controls: ->
    @SEND
      '#buttonProjectAdd':
        enabled: yes
      '#buttonProjectRemove':
  ...
  automatically_render_project_info: ->
    @SEND
      '#projectName':
  ...
  automatically_render_snippet: ->
    @SEND '#textBoxSnippet': text: @selectedProject?.snippet or ''

  automatically_render_url: ->
  ...
  # automatically_render_path_tree: ->
  #   @SEND
