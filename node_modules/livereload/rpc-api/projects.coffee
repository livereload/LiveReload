...
exports.Session_SaveProjects =
class Session_SaveProjects

  saveProjects: ->
    # @makeProjectsMemento (err, projects) ->
    #   throw err if err
    #   return unless _dataFile
    #   memento = { projects }
    #   fs.writeFileSync(_dataFile, JSON.stringify(memento, null, 2))

  # automatically_saveProjects: ->
  #   @saveProjects()
...
exports.preinit = (universe) ->
  universe.define(Session_SaveProjects)
...
exports.init = (vfs, session, appDataDir) ->
  ...
  _session.saveProjects()  # the initial invocation of the automatic block might have already completed
...
exports.api =
  ...
  updateModelFromNative: (memento, callback) ->
    _session.setProjectsMemento(_vfs, memento)
    callback(null)
