...
Specifies a list of mixins to include into the current mixin's entity. Must be a class or a list of classes; the classes are something that you could pass to `universe.register`, short for the naming convention (you don't have to prefix included mixins with the entity name; you can have shared mixins that are included into multiple entities).
