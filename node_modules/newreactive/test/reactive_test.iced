...
describe 'R.Universe', ->
  ...
  describe '#register(klass)', ->
    ...
    describe "given a regular class", ->
      beforeEach -> @universe.register(EmptyEntity)
...
describe "R.Task", ->
  ...
  beforeEach ->
    ...
    @entity = @universe.create('EmptyEntity')
  ...
  describe "with AUTOREPEAT type, sync function and no subtasks", ->
    beforeEach ->
      @task1 = new R.Task(@entity, new R.TaskDef(@universe, 'smt', R.TaskDef.AUTOREPEAT, @log.pusher("RTask1_smt.run")))
      @log.inspectTaskEvents(@task1, ['completed', 'finalized'])
