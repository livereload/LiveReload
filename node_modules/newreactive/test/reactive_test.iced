...
helpers =
  ...
  performAndWait: (name, func) ->
    beforeEach (done) ->
      @performAndWait done, name, func.call(this)
...
describe 'R.Entity attribute', ->
  ...
  describe "with a compute function", ->
    ...
    describe "when the source value is updated", ->
      ...
      it.skip "the computed values is also eventually updated", ->
...
describe "R.Task", ->
  ...
  describe "with AUTOREPEAT type, sync function and no subtasks", ->
    beforeEach ->
      @task1 = new R.Task(@root, new R.TaskDef(@universe, 'smt', R.TaskDef.AUTOREPEAT, @log.pusher("RTask1_smt.run")))
      @log.inspectTaskEvents(@task1, ['completed', 'finalized'])
