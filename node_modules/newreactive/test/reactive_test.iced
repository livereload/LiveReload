...
describe "R.Collection", ->
  ...
  describe 'basic functionality', ->
    helpers.registers(MyApp_RubyCollection1).creates('entity', 'MyApp')
  ...
  describe "computed source collections", ->
    helpers.registers(MyApp_SystemRubies).createsInJob('entity', 'MyApp')
