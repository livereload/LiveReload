...
describe 'R.Entity', ->
  ...
  describe "with a magical automatically_ block", ->
    helpers.registers(SimpleEntity_WithAutomaticalBlock).createsInJob('entity', 'SimpleEntity', someValue: 42)
...
describe 'R.Entity attribute', ->
  ...
  describe "with a default value", ->
    helpers.usesRootEntity().registers(MyApp_EventCount_WithDefault).creates('entity', 'MyApp')
...
describe "R.Task", ->
  ...
  describe "with AUTOREPEAT type and a sync function that loves to change its dependencies", ->
    helpers.inspectSubscriptions().registers(MyApp_EventCount, MyApp_DoubleEventCount, MyApp_Status1).creates('entity', 'MyApp', eventCount: 10)
