...
class RModel extends EventEmitter
  ...
  constructor: (options) ->
    ...
    for mixin in schema.mixinClasses
      mixin.prototype.initialize?.call(this, options)

  toString: -> @_id

  # TODO: remove this method after removing all calls to super.initialize in all initialize methods of all models
  initialize: (options) ->
