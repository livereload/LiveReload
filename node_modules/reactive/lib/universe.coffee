...
class RUniverse extends EventEmitter
  ...
  modelSchema: (modelClass) ->
    ...
    unless @_modelSchemas.hasOwnProperty(modelClass.name)
      schema = @_modelSchemas[modelClass.name] = new RModelSchema(this, modelClass)
      schema.mixin modelClass
    @_modelSchemas[modelClass.name]
