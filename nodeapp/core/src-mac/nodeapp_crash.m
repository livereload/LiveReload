...
void nodeapp_emergency_shutdown_backend_crashed(const char *reason) {
    ...
    NSInteger result = [[NSAlert alertWithMessageText:@"" NODEAPP_BACKENDCRASH_TITLE defaultButton:@"" NODEAPP_BACKENDCRASH_BUTTON_HELP alternateButton:@"" NODEAPP_BACKENDCRASH_BUTTON_QUIT otherButton:nil informativeTextWithFormat:[NSString stringWithUTF8String:message]] runModal];
