{ ok, equal, deepEqual, strictEqual, throws } = require 'assert'
...
describe 'types', ->
  ...
  describe 'object(Foo)', ->
    ...
    #   class Foo
    #   strictEqual types.coerce(null, Foo), null

    it "should complain about null", ->
      class Foo
      throws (-> types.coerce(null, Foo)), /Invalid null value/
